...
select *,
ROW_NUMBER() over(order by product_revenue asc) as revenue_rank_asc,
ROW_NUMBER() over(order by product_revenue desc) as revenue_rank_desc
...
revenue_rank_desc as revenue_rank
from product_revenue_ranked
where revenue_rank_asc <= 10